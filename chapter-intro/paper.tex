...
\plot{shots}{width=0.45\columnwidth}{Synthetic Shot record}
\multiplot{2}{mig1,lsrtm}{width=0.45\columnwidth}{RTM Image(left) without Inverse Hessian (right) with Inverse Hessian }
