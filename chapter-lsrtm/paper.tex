...
We use the weights in Figure \ref{fig:iw,iw5,iw10} and \ref{fig:iwf,iwf5,iwf10}) to form a preconditioner according to equation (\ref{prec}). In particular, we chose the weights obtained after 2 update iterations. This choice was not made based on any preference. Rather, it was due to the availability of results at that time when this subsequent experiment was performed.
...
\plot{zm1}{width=0.7\columnwidth}{Marmousi - Zoom-in comparison 1 between CG and Preconditioned CG}
\plot{zm2}{width=0.7\columnwidth}{Marmousi - Zoom-in comparison 2 comparison between CG and Preconditioned CG}
\plot{zm3}{width=0.7\columnwidth}{Marmousi - Zoom-in comparison 3 comparison between CG and Preconditioned CG}
\plot{zm4}{width=1.0\columnwidth}{Marmousi - Zoom-in comparison 4 comparison between CG and Preconditioned CG}
